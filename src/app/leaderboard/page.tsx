...
// ==========================================
// 1. MAIN LAYOUT (Tabs never freeze!)
// ==========================================
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-50/50 pb-12">
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        {/* 🚀 SUSPENSE 1: Top 4 Stat Cards */}
        <Suspense key={`cards-${currentTab}`} fallback={<StatCardsSkeleton />}>
          <StatCards currentTab={currentTab} />
        </Suspense>

        {/* 🚀 STATIC TABS: Placed exactly where you requested them */}
        ...
        {/* 🚀 SUSPENSE 2: Podium & Lists */}
        <Suspense key={`main-${currentTab}`} fallback={<MainContentSkeleton />}>
          <LeaderboardContent currentTab={currentTab} />
        </Suspense>
...
function StatCardsSkeleton() {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-10 animate-pulse">
      {[...Array(4)].map((_, i) => (
        <div key={i} className="bg-slate-200/60 h-[92px] sm:h-[104px] rounded-2xl border border-slate-100"></div>
      ))}
    </div>
  );
}
...
function MainContentSkeleton() {
  return (
    <div className="animate-pulse">
      <div className="flex flex-col md:flex-row justify-center items-end gap-6 mb-16 hidden md:flex">
        <div className="bg-slate-200/60 w-64 h-56 rounded-3xl"></div>
        <div className="bg-indigo-100/50 w-72 h-72 rounded-3xl"></div>
        <div className="bg-slate-200/60 w-64 h-56 rounded-3xl"></div>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-start">
        <div className="lg:col-span-2 bg-slate-200/60 h-96 rounded-3xl"></div>
        <div className="lg:col-span-1 bg-slate-200/60 h-96 rounded-3xl"></div>
      </div>
    </div>
  );
}
...
// ==========================================
async function StatCards({ currentTab }: { currentTab: string }) {
  const { users, me } = await getLeaderboardPageData(currentTab);
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-10 animate-in fade-in duration-500">
...
// ==========================================
// 4. MAIN LEADERBOARD CONTENT
// ==========================================
async function LeaderboardContent({ currentTab }: { currentTab: string }) {
  ...
  return (
    <>
      {podiumUsers.length > 0 && (
        <div className="flex flex-col md:flex-row justify-center items-center md:items-end gap-14 md:gap-6 mb-16 px-4 pt-8 md:pt-0 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-start animate-in fade-in duration-500">
